...
exports.acceptUpdateCommuntyDescriptionRequest = exports.acceptModeratorRequest = exports.declineModeratorRequest = void 0;
...
exports.acceptModeratorRequest = (0, catchAsync_1.default)((req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const moderatorNotification = yield communityModeratorChangeRequestsSerivce_1.default
        .acceptUpdateCommunityField[moderatorRequest.requestType](community, moderatorRequest, shouldNotifyModerator);
...
exports.acceptUpdateCommuntyDescriptionRequest = (0, catchAsync_1.default)((req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
    const community = req.community;
    const moderatorRequest = req.moderatorRequest;
    if (moderatorRequest.status === 'declined') {
        next(new appError_1.default(400, 'You have already declined this request in the past.'));
    ...
    const descriptionInvalid = communityValidator_1.default.validateStringValues(requestDescription, 'description');
    if (descriptionInvalid) {
        next(new appError_1.default(400, descriptionInvalid));
        return;
    }
